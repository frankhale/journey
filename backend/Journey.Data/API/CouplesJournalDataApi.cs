using Journey.Data.Entities;
using Journey.Data.Model;
...
namespace Journey.Data.API
{
    public class JourneyDataApi : IJourneyDataApi, IDisposable
    {
        private readonly JourneyDbContext _db;
        private readonly ClaimsPrincipal _user;
        private bool disposedValue;

        public JourneyDataApi(JourneyDbContext db, ClaimsPrincipal claimsPrincipal = null)
        {
            _db = db;
